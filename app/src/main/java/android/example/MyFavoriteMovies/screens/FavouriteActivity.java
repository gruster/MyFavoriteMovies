...
public class FavouriteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewFavouriteMovies = findViewById(R.id.recyclerViewFavoriteMovies);
        recyclerViewFavouriteMovies.setLayoutManager(new GridLayoutManager(this, DisplayWidth.getColumnCount(this)));
